...
func handler(conn net.PacketConn, peer net.Addr, m *dhcpv4.DHCPv4) {
	...
	if !allowed && !strings.Contains(class, "PXEClient") && class != "Linux ipconfig" && !strings.Contains(class, "anaconda-Linux") && class != "d-i" {
		log.Print("Ignoring non PXEClient/Linux ipconfig/anaconda-Linux/d-i")
		return
	}
